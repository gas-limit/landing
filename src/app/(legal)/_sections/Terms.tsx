	...
	return (
		<>
			...
			<p>
				...
				and any related services provided by {app.name}.
			</p>
			<p>
				By accessing{" "}
				<Link className={`legal underline `} href={app.url}>
				...
				using any other services provided by {app.name}.
			</p>
			<p>
				We, {app.name}, reserve the right to review and amend any of these Terms
			...
			<p>These Terms of Service were last updated on 28 February 2021.</p>
			...
			<p>
				...
				owned by or licensed to {app.name} and are protected by applicable
			...
			<p>
				...
				&lsquo;as is&rsquo; basis. To the extent permitted by law, {app.name}{" "}
			...
			<p>
				In no event shall {app.name} or its suppliers be liable for any
				...
				on this website, even if {app.name} or an authorized representative has
			...
			<p>
				...
				general information purposes only. {app.name} does not warrant or make
			...
			<h2>Links</h2>
			<p>
				{app.name} has not reviewed all of the sites linked to its website and
				is not responsible for the contents of any such linked site. The
				inclusion of any link does not imply endorsement, approval, or control
				by
				{app.name} of the site. Use of any such linked site is at your own risk
