		...
		shortcuts: [
			{
				...
				description: "Coven Finance's Accessibility Statement",
			},
			{
				name: "Terms of Service",
				url: "/legal/terms",
				description: "Coven Finance's Terms of Service",
			},
			{
				name: "Privacy Policy",
				url: "/legal/privacy",
				description: "Coven Finance's Privacy Policy",
			},
			{
				name: "Cookies Policy",
				url: "/legal/cookies",
				description: "Coven Finance's Cookies Policy",
			},
		],
		screenshots: [
			{
